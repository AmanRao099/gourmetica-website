...
export default function Products() {
  ...
  const handleVideoLoadedData = (e: SyntheticEvent<HTMLVideoElement, Event>) => {
    console.log("Product demo video loaded data successfully", e.currentTarget.videoWidth);
  };

  const handleVideoCanPlay = (e: SyntheticEvent<HTMLVideoElement, Event>) => {
    console.log("Product demo video can play", e.currentTarget.readyState);
  };

  const handleVideoError = (e: SyntheticEvent<HTMLVideoElement, Event>) => {
    console.warn("Product demo video not loaded (this is expected if local video assets are not present in workspace):", e.currentTarget.src);
  };
