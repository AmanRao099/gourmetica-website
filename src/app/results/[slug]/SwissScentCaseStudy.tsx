export default function SwissScentCaseStudy() {
  return (
    <main className="swissscent-clone">
      ...
      <div className="case-clone-image-block">
        <img src="/images/results/swiss-scent-ref/swisssent1.png" alt="" />
      </div>

      <div className="case-clone-image-pair">
        <div>
      ...
      <section className="case-clone-row" style={{ marginTop: "50px" }}>
        <div className="case-clone-row-label">
          <h3 style={{ fontSize: "35px" }}>Solutions Provided by Gourmetica:</h3>
        </div>
        <div className="case-clone-row-content" />
      </section>
      ...
      <div className="case-clone-image-block">
        <img src="/images/results/swiss-scent-ref/swisssent5.png" alt="" />
      </div>
    </main>
  );
}
